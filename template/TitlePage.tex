...
\def\maketitle{%
  ...
  \begin{titlepage}
    ...
    {\large \bfseries \@degree } \vskip 1mm
    {\large in } \vskip 1mm
    {\large \bfseries \@subject} \vskip 2mm
    {\large as part of} \vskip 1mm
    {\large \bfseries \@school } \vskip 1mm
...
\def\declaration{
  ...
  \begin{center}
    \vskip 2cm
    \large \sffamily
    I, Ross Callaghan, confirm that the work presented in this thesis is my own. Where information has been derived from other sources, I confirm that this has been indicated in the thesis.
    \vskip 1cm
    \includegraphics[width=4cm]{template/logos/signature.pdf}
  \end{center}
  \vspace*{\fill}
}
